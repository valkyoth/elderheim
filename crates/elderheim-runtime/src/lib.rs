...
impl RuntimeFragment {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            Self::WriteStatic => "write_static",
            Self::PrintI64 => "print_i64",
            Self::ReadLine => "read_line",
            Self::ParseI64 => "parse_i64",
            Self::BoundsFail => "bounds_fail",
            Self::DivZeroFail => "div_zero_fail",
            Self::Exit => "exit",
        }
    }
    ...
    const fn bit(self) -> u16 {
        match self {
            Self::WriteStatic => 0b000_0001,
            Self::PrintI64 => 0b000_0010,
            Self::ReadLine => 0b000_0100,
            Self::ParseI64 => 0b000_1000,
            Self::BoundsFail => 0b001_0000,
            Self::DivZeroFail => 0b010_0000,
            Self::Exit => 0b100_0000,
        }
    }
}
