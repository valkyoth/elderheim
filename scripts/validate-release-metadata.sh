...
test -f security/pentest/0.6.0.md
grep -Eq '^Reviewed-Commit: (TBD|[0-9a-f]{40})$' security/pentest/0.6.0.md
grep -Eq '^Remediation-Commit: (TBD|[0-9a-f]{40})$' security/pentest/0.6.0.md
